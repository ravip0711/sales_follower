...
group :development, :test do
  ...
  # Factory girl to make factories
  gem 'factory_girl_rails'

  # Will access local variables in .env file before starting app on Heroku
  # To test devise email in development use the following command:
  # $foreman start
  gem 'foreman'
end
